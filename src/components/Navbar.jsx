  ...
  return (
    <nav className={`${styles.paddingX} w-full flex items-center py-5 fixed top-0 z-20 bg-primary`}>
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        <p className="text-white font-poppins font-medium cursor-pointer text-[18px] flex">Pooja N G&nbsp;<span className="sm:block">|&nbsp;Fullstack Dev</span></p>
      </Link>
      ...
      <div className="sm:hidden flex flex-1 justify-end items-center">
          <img src={ toggle ? close : menu} alt="menu" className="w-10 h-10 object-contain cursor-pointer" onClick={() => setToggle(!toggle)}/>
